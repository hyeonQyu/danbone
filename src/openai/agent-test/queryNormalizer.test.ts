import { LocalizedTextSchema, Text } from '@/openai/schemes';
import z from 'zod';
import { TestCase } from './agent.test.types';

type LocalizedText = z.infer<typeof LocalizedTextSchema>;

type QueryNormalizerTestCase = Omit<TestCase<Text>, 'input'> & {
  input: LocalizedText;
};
