...
import { AppRoutesPathname, TypedLink, useBottomNavigation } from '@/routes';
import { usePxToRem, Z_INDEX } from '@/styles';
    ...
    >
      <MUIBottomNavigation showLabels value={currentNavigationIndex}>
        {navigationData.map((item, index) => {
          ...
          const IconComponent = (isActive ? item.iconFilled : item.iconOutlined) as ComponentType;
